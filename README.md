...
Signaturely - это веб-сервис, предназначенный для удобной и безопасной электронной подписи документов. Сервис предоставляет пользователям возможность создавать, редактировать и подписывать различные типы документов онлайн, без необходимости использования бумажных копий или ручных подписей.
...
2. Подробно описать чек-лист проверок для страницы /documents;
3. Добавить к документу 3 баг-репорта.
